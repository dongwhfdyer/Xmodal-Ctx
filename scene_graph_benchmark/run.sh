...
python tools/test_sg_net.py --config-file $configFile TEST.IMS_PER_BATCH 2 MODEL.WEIGHT $modelDir MODEL.ROI_HEADS.NMS_FILTER 1 MODEL.ROI_HEADS.SCORE_THRESH 0.2 DATA_DIR $dataDir TEST.IGNORE_BOX_REGRESSION True MODEL.ATTRIBUTE_ON True TEST.OUTPUT_FEATURE True
